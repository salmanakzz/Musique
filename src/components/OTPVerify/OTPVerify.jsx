...
export const OTPVerify = () => {
    ...
    if (otp.length === 4) {
      otpVerify(state?.number, state?.requestId, otp).then((data) => {
        if (data?.token && data?.user?.verified) {
          showToast("success", "Sign In", "Welcome to your home page!");
  ...
  const resendOtp = () => {
    showToast("success", "OTP Resend", "OTP sent to your mobile number!");
        ...
        <div className="otp-verify">
          <div className="main-container">
            ...
            <div className="mt-1 flex justify-center items-center">
              <span
                className="text-[#000000f0] underline cursor-pointer"
                onClick={resendOtp}
              >
                Resend OTP
              </span>
            ...
            <div className="flex justify-center items-center">
              <Link className="text-[#000000f0] underline" to={"/"}>
                Use another number
              </Link>
            </div>
          </div>
